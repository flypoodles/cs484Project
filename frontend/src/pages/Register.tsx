...
export default function Register({ socket }: { socket: Socket }) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      setError(
        "Failed to register: It seems like there is already an account with that email"
      );
    }
    setLoading(false);
  };
    ...
    <div id="Register">
      ...
      <form className="register-form" onSubmit={handleSubmit}>
        ...
        <div style={{ marginBottom: "5px" }}>
          (This will be your name that other players can view)
        </div>
        <input
          ref={usernameRef}
